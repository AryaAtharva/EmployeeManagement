...
{
$str=$_POST["strr"];
$query="SELECT * FROM stationmaster_mst WHERE Emp_ID like '%$str%' or Employee_Name like '%$str%' or Email_ID like '%$str%' or Address like '%$str%' or Phone_Number like '%$str%' or Station_mst_ID like '%$str%'";
}
else
{
    $query="SELECT * FROM stationmaster_mst ";
}
  ...
  <div class="bdy">
    ...
    <div class="navbar">
      <a href="/rly_intern/home.php">Home</a>
        <span><u>Station Master</u></span>
      <?php if($_SESSION['cat']=="ADMIN")
      {
     echo "<a href=\"index.php\"><u>Show</u></a>";
              ...
              <th align="center" style="font-weight: bold;">Emp_ID</h5></th>
           	...
           	<?php
           	  while($rows=mysqli_fetch_assoc($result))
           	  {
           	  	?>
           	  	<tr>
                    <td align="center"><a href="profile.php?id=<?php echo $rows["Emp_ID"]; ?>" class="td"><?php echo $rows["Emp_ID"]; ?></a></td>
             	  		<td align="center"><a href="profile.php?id=<?php echo $rows["Emp_ID"]; ?>" class="td"><?php echo $rows["Employee_Name"]; ?></a></td>
        						<td align="center"><a href="profile.php?id=<?php echo $rows["Emp_ID"]; ?>" class="td"><?php echo $rows["Email_ID"]; ?></a></td>
        						<td align="center"><a href="profile.php?id=<?php echo $rows["Emp_ID"]; ?>" class="td"><?php echo $rows["Address"]; ?></a></td>
        						<td align="center"><a href="profile.php?id=<?php echo $rows["Emp_ID"]; ?>" class="td"><?php echo $rows["Phone_Number"]; ?></a></td>
        						<td align="center"><a href="profile.php?id=<?php echo $rows["Emp_ID"]; ?>" class="td"><?php echo $rows["Station_mst_ID"]; ?></a></td>
           	  	</tr>
           	  	<?php
           	  }
           ?>
