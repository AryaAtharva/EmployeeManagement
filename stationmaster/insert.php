...
<body>
  <div class="bdy">
    ...
    echo "<a href=\"index.php\"><u>Insert</u></a>";
  ...
  if(filesize($_FILES['image']['tmp_name'])<60000){
    ...
    $s_code=$_POST["station"];
      if($E_id!="" OR $E_name!="" or $Email!="" or $Add!="" or $Ph_no!="" or $s_code!=""){
        $sql = "INSERT INTO stationmaster_mst (Emp_ID,Employee_Name,Email_ID,Address,Phone_Number,Station_mst_ID,stn_master_image)
        VALUES ('$E_id', '$E_name','$Email','$Add','$Ph_no',$s_code,'$image')";
