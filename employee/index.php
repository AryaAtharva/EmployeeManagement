...
<body>
  <div class="bdy">
    ...
    <div class="content">
          ...
          <table  border="1px" style="width:1000px;line-height: 25px; border: 2px solid black; margin: 0 auto; border-radius: 9px; position: absolute; top: 10%; left: 11%;">
