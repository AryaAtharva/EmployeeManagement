...
$_SESSION["table"]="emp";
$Emp_ID=$_GET['id'];
$query="SELECT * FROM employee_mst,station_mst WHERE Stn_ID = Station_mst_ID and Emp_ID='$Emp_ID' and changed='N'";
  ...
  <div class="bdy">
    ...
    <div class="content">
        <form action="#" method="post" class="login" enctype="multipart/form-data">
          <h2><strong>Employee ID :</strong> <?php echo $rows["Emp_ID"]; ?></h2>
          <p class="rt"><img src="data:image/jpeg;base64,<?php echo base64_encode( $rows["Employee_image"] ); ?>" height="160px"/></p>
